...
import com.freeclassroom.courseservice.dto.response.course.LessonCourseAdminTeacherResponse;
...
public interface LessonMapper {
    ...
    LessonCourseAdminTeacherResponse toTeacherAdminResponse(LessonEntity entity);
}
