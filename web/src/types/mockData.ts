...
export const mockCourses: Course[] = [
  {
    ...
    status: 'confirmed',
    description:
      'Khóa học toàn diện về ReactJS, từ các khái niệm cơ bản đến các kỹ thuật nâng cao như hooks, context API, và performance optimization.'
  },
  {
    id: '2',
    ...
    status: 'pending',
    description:
      'Học cách xây dựng RESTful API với Node.js, Express, và MongoDB. Bao gồm authentication, authorization, và best practices.'
  },
  {
    id: '3',
  ...
  },
  {
    ...
    status: 'rejected',
    description:
      'Khóa học về Python áp dụng trong Data Science, bao gồm pandas, numpy, và các thư viện machine learning cơ bản.'
  }
]
...
export const mockCertificates: Certificate[] = [
  ...
  },
  {
    ...
    certificateUrl: 'https://www.credly.com/badges/b2c04f72-b12c-482d-820b-14ccd2027f01/public_url',
    imageUrl:
      'https://png.pngtree.com/png-vector/20210715/ourlarge/pngtree-certificate-graduation-template-design-with-blue-and-golden-png-image_3601584.jpg',
    organization: 'Amazon'
  },
  {
    id: '3',
