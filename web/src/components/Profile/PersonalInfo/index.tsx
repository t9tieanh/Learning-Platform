...
const PersonalInfo = () => {
  ...
  return (
    <div className='space-y-6'>
      ...
      {/* Card */}
      <Card className='border-border bg-profile-card hover:bg-profile-card-hover transition-colors rounded-xl shadow-sm'>
        <CardContent className='p-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 pl-4'>
            ...
            <div>
              ...
              <p className='text-foreground font-medium'>{userInfo.location}</p>
            </div>
            ...
            <div>
              ...
              <p className='text-foreground font-medium'>2</p>
            </div>
          </div>

          <div className='flex justify-center mt-8'>
            <Button className='rounded-lg hover:bg-primary-hover hover:scale-105'>Chỉnh sửa</Button>
          </div>
        </CardContent>
      </Card>
    </div>
