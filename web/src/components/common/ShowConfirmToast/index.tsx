          ...
          <div className='flex-shrink-0'>
            <span className='inline-flex items-center justify-center h-8 w-8 rounded-full bg-red-50'>
              ...
              <svg className='h-4 w-4 text-red-600' viewBox='0 0 20 20' fill='currentColor' aria-hidden='true'>
                <path
                  fillRule='evenodd'
                  d='M8.257 3.099c.765-1.36 2.72-1.36 3.485 0l6.518 11.59A1.75 1.75 0 0 1 16.625 18H3.375a1.75 1.75 0 0 1-1.635-2.311L8.257 3.1zM9 7a1 1 0 10-2 0v3a1 1 0 102 0V7zm-1 7a1.25 1.25 0 110-2.5A1.25 1.25 0 019 14z'
                  clipRule='evenodd'
                />
              </svg>
            </span>
