  ...
  return (
    <div className='max-w-6xl space-y-8'>
      <div className='mb-8 bg-blue-950 text-white rounded-xl shadow-lg p-6'>
        <h1 className='text-2xl font-semibold mb-3 text-blue-300'>Chương trình học</h1>
        <p className='text-blue-100 text-base leading-relaxed'>
          Bắt đầu xây dựng khóa học bằng cách tạo các phần, bài giảng và hoạt động thực hành (
          <span className='underline cursor-pointer'>quiz, bài tập, bài viết</span>
          ). Hãy sắp xếp nội dung rõ ràng, tổng thời lượng video miễn phí phải dưới 2 giờ.
        </p>
