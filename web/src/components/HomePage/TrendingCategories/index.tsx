...
const TrendingCategories = () => {
  const categories = [
    ...
    { title: 'ReactJS', image: 'https://images.icon-icons.com/3781/PNG/512/react_icon_231932.png' },
  ]
  ...
  return (
    <div className='trending-categories-container mt-8 my-5 py-3'>
      ...
      <h4 className='text-center text-3xl title-categories font-extrabold tracking-tight'>
        Chuyên ngành đang được quan tâm
      </h4>
