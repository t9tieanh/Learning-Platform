        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='space-y-8 z-10'>
            ...
            <div className='flex flex-wrap items-center gap-4'>
              <Button
                size='lg'
                className='bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-8 h-14 text-lg'
              >
                Get Started
              </Button>
              <Button
                variant='ghost'
                size='lg'
                className='text-primary hover:text-primary hover:bg-primary/10 h-14 text-lg'
              >
                Get free trial
              </Button>
            </div>
          ...
          <div className='relative flex items-center justify-center'>
            ...
            <div className='relative w-[400px] h-[400px] lg:w-[500px] lg:h-[500px] rounded-full overflow-hidden border-8 border-background shadow-2xl'>
              <img src={anh} alt='Happy student' className='w-full h-full object-cover' />
            </div>
