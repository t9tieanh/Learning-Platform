  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        // 3) Courses (paginated)
        const courseRes = await CourseService.getTeacherCourses(String(userId), { page, limit: pageSize, isPublic: true });
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {loading && (
                  <div className="col-span-2 text-center text-muted-foreground">Đang tải khóa học…</div>
                )}
